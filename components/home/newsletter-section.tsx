            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-0">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="h-14 rounded-r-none border-0 bg-white pl-12 text-foreground focus-visible:ring-luxury-accent"
                />
              </div>
              <Button
                type="submit"
                size="lg"
                disabled={status === "loading" || status === "success"}
                className="h-14 rounded-l-none bg-luxury-accent px-8 text-primary hover:bg-luxury-accent/90"
              >
                {status === "loading" ? (
                  <>
